<template>
   <!-- navbar start -->
    <!-- header start -->
    <header
      class="header-style-5 color-style"
      id="sticky-header"
    ...
    >
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="header-contact">
                <ul>
                  <li style="color: black">Welcome to the Nastars Store!</li>
                  <!-- <li style="color: black">
                    <i class="fa fa-phone" aria-hidden="true"></i>Call Us: 123 -
                    456 - 7890
                  </li> -->
                </ul>
              </div>
          ...
          <div class="col-sm-12">
            <div class="main-menu">
              <div class="menu-left">
                ...
                <div class="brand-logo" style="width: 12rem">
                  <a href="index.html"
                    ><img
                      src="../assets/images/NewImage/Nastars-logo-font-black-1.png"
              ...
              <div>
                <form
                  class="form_search ajax-search the-basics"
                  role="form"
                ...
                >
                  <input
                    ...
                    class="nav-search nav-search-field typeahead"
                    aria-expanded="true"
                    style="border-radius: 24px"
                  />
                  <button
              ...
              <div class="menu-right pull-right">
                ...
                <div class="top-header d-block">
                  <ul class="header-dropdown">
                    <li class="mobile-wishlist">
                      <a href="#"
                        ><img src="../assets/images/icon/heart-1.png" alt="" />
                      </a>
                    </li>
                ...
                <div>
                  <div class="icon-nav">
                    <ul>
                      <li
                        class="onhover-div d-xl-none d-inline-block mobile-search"
                      >
                        <div>
                          <img
                      ...
                      <li class="onhover-div mobile-cart">
                        <div>
                          <img
                            ...
                            alt=""
                          />
                          <!-- <i class='bx bx-shopping-bag' style='color:#000'  ></i> -->
      ...
      <div class="bottom-part" style="background-color: #0071dc; height: 62px">
        <div class="container">
          <div class="row">
            <div class="col-xl-3">
              <div class="category-menu d-none d-xl-block h-100">
                <div
                  ...
                  style="background-color: #f5f5f5; height: 62px"
                >
                  <i class="fa fa-bars sidebar-bar" style="color: #000"></i>
                  <h5 class="mb-0" style="color: #000; font-weight: 600">
                    shop by category
                  </h5>
                </div>
              </div>
              ...
              <div class="main-nav-center">
                <nav class="text-start">
                  ...
                  <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                              ...
                              <div class="col mega-box">
                                <div class="link-section">
                                  ...
                                  <div class="menu-content">
                                    <ul>
                                      <li>
                                        <a target="_blank" href="invoice-1.html"
                                          >invoice 1</a
                                        >
                                      </li>
                                      <li>
                                        <a target="_blank" href="invoice-2.html"
                                          >invoice 2</a
                                        >
                                      </li>
                                      <li>
                                        <a target="_blank" href="invoice-3.html"
                                          >invoice 3</a
                                        >
                                      </li>
                                      <li>
                                        <a target="_blank" href="invoice-4.html"
                                          >invoice 4</a
                                        >
                                      </li>
                                      <li>
                                        <a target="_blank" href="invoice-5.html"
                                          >invoice 5</a
                                        >
                                      </li>
                                    </ul>
                      ...
                      <!-- <ul>
                        <li>
                          <a href="category-page(vegetables).html"
                            >tab style<span class="new-tag">new</span></a
                          >
                        </li>
                        <li>
                      ...
                      <!-- <ul>
                        <li>
                          <a href="product-page(360-view).html"
                            >360 view <span class="new-tag">new</span></a
                          >
                        </li>
                        <li>
                          <a href="product-page(video-thumbnail).html"
                            >video thumbnail<span class="new-tag">new</span></a
                          >
                        </li>
                        <li>
                          <a href="#">sidebar</a>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="order-tracking.html"
                                >order tracking<span class="new-tag"
                                  >new</span
                                ></a
                              >
                            </li>
                    ...
                    <li>
                      <!-- <a href="#" style="color: #fff; font-weight: 600;">blog</a> -->
                      <!-- <ul>
            ...
            <!-- <div class="col-xxl-3 d-none d-xxl-inline-block">
              <div class="header-options">
                <div class="vertical-slider no-arrow">
                  <div>
                    <span
                      ><i class="ti-truck" aria-hidden="true"></i>Free Shipping
                      on Orders $100+</span
                    >
                  </div>
                  <div>
                    <span
                      ><i class="ti-announcement" aria-hidden="true"></i>Buy One
                      Get Two Free</span
                    >
                  </div>
                  <div>
                    <span
                      ><i class="ti-gift" aria-hidden="true"></i>Gift Card for
                      all the season</span
                    >
                  </div>
                </div>
